...
if __name__ == "__main__":
    ...
    # parsing
    trajectory_string = Path("input.txt").read_text()
    ...
    for trajectory in trajectory_list:
        ...
        if 'L' in trajectory:
            current_trajectory = possible_trajectories[possible_trajectories.index(previous_trajectory) - 1]
        elif 'R' in trajectory:
            if possible_trajectories.index(previous_trajectory) == len(possible_trajectories) - 1:
